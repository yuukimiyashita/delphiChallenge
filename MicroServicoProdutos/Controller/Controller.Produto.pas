...
begin
  ...
  try
    wQry := wProdutos.fRetornaProduto(wErro);
...
begin
  ...
  try
    wQry := wProduto.fRetornaProduto(wErro);
...
begin
  ...
  try
    try
      ...
      wProduto.fCadastraProduto(wErro);
...
begin
  ...
  try
    ...
    try
      if not wProduto.fDeletaProduto(wErro) then
        raise Exception.Create(wErro)
