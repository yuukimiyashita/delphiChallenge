...
begin
  ...
  try
    ...
    wProdutoJSON.AddPair('idProduto', TJSONNumber.Create(StrToIntDef(edCodigoProduto.Text, 0)));
    wProdutoJSON.AddPair('nome', edNomeProduto.Text);
    wProdutoJSON.AddPair('descricao', edDescricaoProduto.Text);
    wProdutoJSON.AddPair('precoUnitario', TJSONNumber.Create(StrToFloatDef(wValorAux, 0)));
    wProdutoJSON.AddPair('saldoEstoque', TJSONNumber.Create(StrToIntDef(edSaldoProduto.Text, 0)));
    wProdutoJSON.AddPair('categoria', cbCategoriaProduto.Text);


    if dmDados.fCadastraProdutos(wProdutoJSON) then
      begin
...
begin
  ...
  if dmDados.fDeletaProdutos(wProdutoID) then
